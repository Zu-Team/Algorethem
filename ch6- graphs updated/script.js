...
// Draggable Pseudocode Card
document.addEventListener('DOMContentLoaded', () => {
    const card = document.querySelector('.pseudocode-container');
    if (!card) return;
